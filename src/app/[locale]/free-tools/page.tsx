...
export default async function FreeToolsHub({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
  ...
  return (
    <div className="bg-[#f4f7f6] min-h-screen py-16 px-4">
      ...
      {/* CTAs */}
      <div className="max-w-5xl mx-auto mt-12 px-4 flex flex-col sm:flex-row justify-center items-center gap-6">
        <a
          href="/ebooks"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex justify-center items-center gap-3 bg-[#FED52B] text-[#1E3A1A] font-black uppercase text-lg py-4 px-8 rounded-2xl shadow-xl hover:bg-[#ffe16b] hover:-translate-y-1 transition-all duration-300 tracking-wide w-full sm:w-[320px]"
        >
          <svg className="w-6 h-6 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24"><path d="M21 5c-1.11-.35-2.33-.5-3.5-.5-1.95 0-4.05.4-5.5 1.5-1.45-1.1-3.55-1.5-5.5-1.5S2.45 4.9 1 6v14.65c0 .25.25.5.5.5.1 0 .15-.05.25-.05C3.1 20.45 5.05 20 6.5 20c1.95 0 4.05.4 5.5 1.5 1.35-.85 3.8-1.5 5.5-1.5 1.65 0 3.35.3 4.75 1.05.1.05.15.05.25.05.25 0 .5-.25.5-.5V6c-.6-.45-1.25-.75-2-1zm0 13.5c-1.1-.35-2.3-.5-3.5-.5-1.7 0-4.15.65-5.5 1.5V8c1.35-.85 3.8-1.5 5.5-1.5 1.2 0 2.4.15 3.5.5v11.5z"/></svg>
        ...
        <a
          ...
          className="inline-flex justify-center items-center gap-3 bg-[#FED52B] text-[#1E3A1A] font-black uppercase text-lg py-4 px-8 rounded-2xl shadow-xl hover:bg-[#ffe16b] hover:-translate-y-1 transition-all duration-300 tracking-wide w-full sm:w-[320px]"
        >
          <svg className="w-6 h-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
