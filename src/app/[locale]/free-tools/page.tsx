    ...
    <div className="bg-[#f4f7f6] min-h-screen py-16 px-4">
      ...
      <div className="max-w-5xl mx-auto mt-12 px-4 text-center">
        <a
          ...
          className="inline-flex items-center gap-3 bg-[#1E3A1A] text-[#FED52B] font-black uppercase text-lg py-4 px-10 rounded-2xl shadow-xl hover:bg-[#2a5124] hover:-translate-y-1 transition-all duration-300 tracking-wide"
        >
