...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: meta.title,
      description: meta.description,
      url: `https://lemonadeideas.com/${locale}/blogs/blueprint-web-design`,
      siteName: 'Lemonade Ideas',
      images: [
        {
          url: 'https://lemonadeideas.com/images/blogs/blueprint-web-design/hero.png',
          width: 1200,
          height: 630,
          alt: meta.title,
        },
    ...
    twitter: {
      ...
      title: meta.title,
      description: meta.description,
      images: ['https://lemonadeideas.com/images/blogs/blueprint-web-design/hero.png'],
    },
  };
}
