...
export default function BlogPost() {
  return (
    <div className="flex flex-col min-h-screen bg-white font-['Poppins',sans-serif]">
      <Head>
        <title>ROI en Rotulación Comercial: El Anuncio Móvil que Impulsa el Marketing de Construcción</title>
        <meta name="description" content="Descubra por qué dejar los vehículos de servicio comercial en blanco le está costando millones. Aprenda las matemáticas, la psicología y el diseño de los rotulados altamente rentables." />
        <link
          rel="stylesheet"
