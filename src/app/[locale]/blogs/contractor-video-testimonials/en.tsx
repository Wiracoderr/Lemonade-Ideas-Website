      ...
      <main className="flex-1 px-4 md:px-[20px] bg-[#fcfcfc]">
        <article className="max-w-[800px] mx-auto bg-white rounded-[24px] shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] mt-[-40px] relative z-20 pt-[50px] px-[20px] md:px-[60px] pb-[60px] text-[#333] leading-[1.8] border border-gray-100">
          ...
          <div className="prose prose-lg max-w-none text-[#444] text-justify prose-headings:font-['Oswald',sans-serif] prose-p:text-[1.1rem] prose-p:leading-[1.8] prose-p:mb-[30px] prose-a:text-[#3AAB43] hover:prose-a:text-[#1E3A1A] prose-strong:text-[#1E3A1A] prose-strong:font-bold prose-ul:list-none prose-ul:pl-0 prose-li:relative prose-li:pl-[28px] prose-li:mb-[15px]">
            ...
            <ul>
              <li><Check className="text-[#3AAB43] absolute left-0 top-[6px]" /> <strong>1. The Baseline Pain:</strong> "Before you hired us, what was your biggest frustration with other contractors on past commercial builds?"</li>
              <li><Check className="text-[#3AAB43] absolute left-0 top-[6px]" /> <strong>2. The Decision Factor:</strong> "Why did you ultimately choose our firm over the three other bids you received?"</li>
              <li><Check className="text-[#3AAB43] absolute left-0 top-[6px]" /> <strong>3. The Execution:</strong> "During the actual build phase, what surprised you the most about how our project managers operated?"</li>
              <li><Check className="text-[#3AAB43] absolute left-0 top-[6px]" /> <strong>4. The ROI:</strong> "If you were speaking to another developer considering hiring us, what would you tell them about the final result?"</li>
            </ul>
