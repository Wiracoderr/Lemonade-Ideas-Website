...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: meta.title,
      description: meta.description,
      url: `https://www.lemonadeideas.com/${locale}/blogs/contractor-sales-scripts`,
      siteName: 'Lemonade Ideas',
      images: [
        {
          url: 'https://www.lemonadeideas.com/images/blogs/contractor-sales-scripts/hero.png',
          width: 1200,
          height: 630,
          alt: meta.title,
        },
    ...
    twitter: {
      ...
      title: meta.title,
      description: meta.description,
      images: ['https://www.lemonadeideas.com/images/blogs/contractor-sales-scripts/hero.png'],
    },
  };
}
