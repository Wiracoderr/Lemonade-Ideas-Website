  ...
  return (
    <div className="flex flex-col min-h-screen bg-white font-['Poppins',sans-serif]">
      <Head>
        ...
        />
        <title>Fotografía con Drones: Cómo los Contratistas Logran un ROI del 275% | Lemonade Ideas</title>
        <meta name="description" content="Descubre cómo la fotogrametría aérea y los drones están reduciendo los tiempos de inspección en un 60% y mitigando riesgos en la construcción." />
      </Head>
