...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: meta.title,
      description: meta.description,
      url: `https://lemonadeideas.com/${locale}/blogs/inbound-marketing-commercial-contractors`,
      siteName: 'Lemonade Ideas',
      images: [
        {
          url: 'https://lemonadeideas.com/images/blogs/inbound-marketing-commercial-contractors/hero.png',
          width: 1200,
          height: 630,
          alt: meta.title,
        },
    ...
    twitter: {
      ...
      title: meta.title,
      description: meta.description,
      images: ['https://lemonadeideas.com/images/blogs/inbound-marketing-commercial-contractors/hero.png'],
    },
  };
}
