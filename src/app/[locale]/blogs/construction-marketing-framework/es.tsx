  ...
  return (
    <div className="flex flex-col min-h-screen bg-white font-['Poppins',sans-serif]">
      <Head>
        ...
        />
        <title>Marketing para Construcción: El Plano para Dejar de Competir por Precio | Lemonade Ideas</title>
        <meta name="description" content="Una guía completa y basada en datos sobre marketing B2B para construcción. Aprende cómo construir un motor de leads entrantes que te posicione como la autoridad indiscutible." />
      </Head>
