  ...
  return (
    <div className="flex flex-col min-h-screen bg-white font-['Poppins',sans-serif]">
      <Head>
        ...
        />
        <title>Leads de Construcción: Deja de Comprar Leads Compartidos y Construye el Tuyo | Lemonade Ideas</title>
        <meta name="description" content="Descubre por qué comprar leads de construcción compartidos destruye tu tasa de cierre y la matemática exacta detrás de construir tu propio motor de generación de leads B2B." />
      </Head>
