...
export default function BlogPost() {
  return (
    <div className="flex flex-col min-h-screen bg-white font-['Poppins',sans-serif]">
      <Head>
        <title>ADA Compliant Construction Websites: Exposing the Predatory $50k Title III Lawsuit Crisis</title>
        <meta name="description" content="Commercial contractors are bleeding horrifying sums of raw capital to predatory legal firms exploiting non-compliant, archaic construction websites lacking strict WCAG 2.1 AA digital architecture." />
        <link
          rel="stylesheet"
