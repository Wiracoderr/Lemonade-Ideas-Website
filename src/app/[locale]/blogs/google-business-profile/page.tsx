...
export async function generateMetadata({ params: { locale } }: { params: { locale: string } }) {
  return {
    ...
    alternates: {
      canonical: `https://www.lemonadeideas.com/${locale}/blogs/google-business-profile`,
      languages: {
        'en': 'https://www.lemonadeideas.com/en/blogs/google-business-profile',
        'es': 'https://www.lemonadeideas.com/es/blogs/google-business-profile',
      },
    },
    openGraph: {
      title: locale === 'es'
      ...
      url: `https://www.lemonadeideas.com/${locale}/blogs/google-business-profile`,
      siteName: 'Lemonade Ideas',
      images: [
        {
          url: 'https://www.lemonadeideas.com/images/blogs/google-business-profile/hero.png',
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      description: locale === 'es'
        ? 'Cómo los contratistas comerciales de élite de 8 cifras diseñan monopolios digitales convirtiendo su Perfil de Negocio de'
        : 'How elite 8-figure commercial contractors engineer digital monopolies by turning their Google Business Profile into a se',
      images: ['https://www.lemonadeideas.com/images/blogs/google-business-profile/hero.png'],
    },
  };
}
