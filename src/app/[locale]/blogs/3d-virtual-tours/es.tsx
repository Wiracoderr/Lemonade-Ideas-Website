...
export default function BlogPost() {
  return (
    <div className="flex flex-col min-h-screen bg-white font-['Poppins',sans-serif]">
      <Head>
        <title>Recorridos Virtuales 3D en Pre-Construcción: La Máxima Defensa Contra la Corrupción del Alcance</title>
        <meta name="description" content="Deje de perder margen en órdenes de cambio. Aprenda cómo el uso de Recorridos Virtuales 3D durante la pre-construcción elimina la fricción del cliente, justifica los precios premium y acelera los ciclos de ventas B2B." />
        <link
          rel="stylesheet"
