...
export default function BlogPost() {
  return (
    <div className="flex flex-col min-h-screen bg-white font-['Poppins',sans-serif]">
      <Head>
        <title>Ventas de Construcción de Alto Valor: Deje de Competir por Precio, Empiece a Cerrar por Dominio</title>
        <meta name="description" content="Descubra la psicología de élite y los esquemas tácticos requeridos para que los contratistas comerciales ganen ofertas masivas de alto valor sin sacrificar sus márgenes de ganancia." />
        <link
          rel="stylesheet"
