...
export default function BlogPost() {
  return (
    <div className="flex flex-col min-h-screen bg-white font-['Poppins',sans-serif]">
      <Head>
        <title>Fast Loading Sites: The Mandatory Digital Speed Required to Close Elite Construction Bids</title>
        <meta name="description" content="Discover why wealthy B2B commercial developers instantly bounce from slow contractor websites and how Core Web Vitals optimization protects your firm's professional authority." />
        <link
          rel="stylesheet"
