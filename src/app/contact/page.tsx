            ...
            <section className="bg-white pt-[120px] pb-16 md:pt-[160px] md:pb-24 text-center px-4">
                <div className="max-w-4xl mx-auto">
                    <h1 className="text-[24px] md:text-[32px] lg:text-[38px] font-[Oswald] font-bold uppercase leading-snug tracking-wide text-[#1E3A1A] mb-4">
                        WE TAKE PRIDE IN PROVIDING EXCEPTIONAL CUSTOMER SERVICE.<br />
                        HAVE QUESTIONS? SPEAK DIRECTLY WITH OUR EXPERT!
                    </h1>
            ...
            <section className="flex flex-col md:flex-row w-full">
                ...
                <div className="w-full md:w-1/2 bg-[#f2f8f9] p-8 md:p-14 lg:p-20 xl:p-24 flex flex-col justify-center">
                    <h2 className="text-[20px] md:text-[24px] lg:text-[28px] font-[Oswald] font-bold uppercase text-[#1E3A1A] mb-8 lg:mb-10">
                        EMAIL OUR MARKETING EXPERT WITH YOUR QUESTIONS:
                    </h2>
                ...
                <div className="w-full md:w-1/2 bg-[#222222] p-8 md:p-14 lg:p-20 xl:p-24 flex flex-col justify-center text-white">
                    ...
                    <p className="text-[13px] md:text-[14px] leading-relaxed mb-10 text-[#d1d5db]">
                        We practice what we preach. Our goal is to make you a long-term partner of ours, and we&apos;ll work hard to make that happen.
                    </p>
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-bold text-[#FED52B] text-[15px] mb-1.5">We Walk the Talk</h3>
                                <p className="text-[13px] text-[#9ca3af] leading-relaxed">
                                    Our goal is to build lasting partnerships. We&apos;re dedicated to earning your trust and becoming a valuable part of your team.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-bold text-[#FED52B] text-[15px] mb-1.5">No Contracts</h3>
                                <p className="text-[13px] text-[#9ca3af] leading-relaxed">
                                    We believe in flexibility. That&apos;s why we operate on a month-to-month basis—no long-term commitments required.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-bold text-[#FED52B] text-[15px] mb-1.5">Affordable Prices</h3>
                                <p className="text-[13px] text-[#9ca3af] leading-relaxed">
                                    High-quality services at competitive prices. It&apos;s a winning combination that delivers real value.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="font-bold text-[#FED52B] text-[15px] mb-1.5">Designed for Small Businesses</h3>
                                <p className="text-[13px] text-[#9ca3af] leading-relaxed">
                                    While we work with businesses of all sizes across the country, small businesses are at the heart of what we do. Don&apos;t hesitate to reach out!
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="bg-[#143d1f] py-24 md:py-32 px-4 relative overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto text-center relative z-10 text-white">
                    <h2 className="text-[26px] md:text-[36px] lg:text-[42px] font-[Oswald] font-bold uppercase leading-tight tracking-wide text-white mb-6">
                        PREFER TO TALK RATHER THAN EMAIL?
                    </h2>
                    ...
                    >
                        ...
                        <div className="flex flex-col items-start text-left pt-1">
                            <span className="text-[9px] md:text-[11px] mb-[2px] tracking-[0.10em] md:tracking-[0.15em] opacity-80 group-hover:opacity-100 font-sans font-semibold">SPEAK WITH OUR EXPERT</span>
                            <span className="text-[20px] md:text-[26px] leading-none tracking-normal">SCHEDULE A CALL</span>
                        </div>
                    </a>
                </div>
            </section>
