  ...
  return (
    <div className="flex flex-col min-h-screen bg-white font-['Poppins',sans-serif]">
      <Head>
        ...
        />
        <title>How B2B Construction Case Studies Actually Close Deals | Lemonade Ideas</title>
        <meta name="description" content="Stop using basic before-and-after photos. Learn the exact B2B psychological framework for writing construction case studies that act as your highest-converting sales assets." />
      </Head>
          ...
          <div className="prose prose-lg max-w-none text-[#444] text-justify prose-headings:font-['Oswald',sans-serif] prose-p:text-[1.1rem] prose-p:leading-[1.8] prose-p:mb-[30px] prose-a:text-[#3AAB43] hover:prose-a:text-[#1E3A1A] prose-strong:text-[#1E3A1A] prose-strong:font-bold prose-ul:list-none prose-ul:pl-0 prose-li:relative prose-li:pl-[28px] prose-li:mb-[15px]">
            ...
            <div className="bg-[#fff5f5] p-[30px] rounded-[16px] mb-[40px] relative overflow-hidden group border border-[#ffebeb]">
              ...
              <h4 className="text-[#d32f2f] font-bold mb-[15px] relative z-10 flex items-center gap-3">
                <i className="fas fa-exclamation-triangle"></i> The Fatal Flaw
              </h4>
            ...
            <ul>
              <li><i className="fas fa-times text-red-500 absolute left-0 top-[6px]"></i> <strong>Weak:</strong> The TechCorp Office Buildout</li>
              <li><i className="fas fa-check text-[#3AAB43] absolute left-0 top-[6px]"></i> <strong>Strong:</strong> How We Delivered TechCorp&apos;s 40,000 Sq Ft Headquarters 3 Weeks Early Despite Global Supply Chain Bottlenecks</li>
            </ul>
            ...
            <ul>
              <li><i className="fas fa-check text-[#3AAB43] absolute left-0 top-[6px]"></i> What was your absolute biggest fear before hiring us?</li>
              <li><i className="fas fa-check text-[#3AAB43] absolute left-0 top-[6px]"></i> Was there a specific moment during construction where you realized you made the right choice?</li>
              <li><i className="fas fa-check text-[#3AAB43] absolute left-0 top-[6px]"></i> How has the new space tangibly impacted your business operations?</li>
            </ul>
            <p>
