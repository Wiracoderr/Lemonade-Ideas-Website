        ...
        <div className="font-sans">
            ...
            <header className="bg-[#1E3A1A] text-white relative overflow-hidden font-sans">
                ...
                <div className="absolute inset-0 z-0">
                    {/* Desktop Version */}
                    <Image
                        src="/images/google-ads-hero-bg.webp"
                        ...
                        <div className="w-full lg:w-[55%] pl-0 relative z-10">
                            ...
                            <div className="aspect-video bg-black/90 shadow-[0_30px_60px_rgba(0,0,0,0.6)] w-full max-w-[900px] flex items-center justify-center relative overflow-hidden border-[4px] lg:border-[6px] border-white ml-auto">
                                {!isPlaying ? (
                                    ...
                                    >
                                        {/* Using the same background for the video thumbnail so it looks cohesive */}
                                        <Image
                                            src="/images/google-ads-video-thumb.webp"
                                            alt="Watch Video"
                                            fill
                                    ...
                                    <iframe
                                        ...
                                        src="https://www.youtube.com/embed/w8ttnv-2kL0?autoplay=1&start=1&rel=0"
                                        title="Lemonade Ideas Google Ads Video"
                                        frameBorder="0"
