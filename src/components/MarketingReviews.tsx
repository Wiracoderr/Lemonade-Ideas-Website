    ...
    return (
        <section className="py-24 bg-white dark:bg-gray-900">
            <div className="container mx-auto px-4 text-center">
                ...
                <a className="bg-[#1e3a29] hover:bg-[#284d23] text-white font-bold py-4 px-10 rounded text-sm uppercase transition duration-300 inline-block font-display tracking-widest" href="#">Read More Reviews</a>
            </div>
        </section>
    );
}
