...
const inputImage = path.join(process.cwd(), 'Icons/1x/Mesa de trabajo 1-100.jpg');
const outputPathWebp = path.join(process.cwd(), 'public', 'images', 'smm-expertise-bg.webp');
